...
parser.add_argument('-d', '--dry-run', action='store_true', dest='dry_run',
                    ...
                    "A nonzero exit code indicates an exception occurred.")
...
def apply_update(args, update):
    ...
    verbose_aware_exec(["launchctl", "unload", "~/Library/LaunchAgents/net.arko.factorio.plist"])
    verbose_aware_exec(update_args, args.verbose)
    verbose_aware_exec(["launchctl", "load", "~/Library/LaunchAgents/net.arko.factorio.plist"])
